          ...
          <div className="relative duration-1000 animate-in slide-in-from-right-4">
            <Card className="hover:shadow-3xl group overflow-hidden border-gold-300/20 shadow-2xl transition-all duration-500">
              <CardContent className="p-0">
                <div className="relative flex aspect-[4/3] items-center justify-center overflow-hidden bg-navy-600">
                  <div className="z-10 text-center text-cream-200">
              ...
              <CardContent className="p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-navy-400">(702) 555-REALTOR</div>
