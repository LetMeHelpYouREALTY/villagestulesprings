        ...
        <Tabs className="gap-4" defaultValue="virtual">
          ...
          <TabsContent value="virtual">
            <div className="space-y-4">
              <div className="aspect-8/5 perspective-distant relative w-full max-w-96 overflow-hidden rounded-xl bg-primary">
                <div className="absolute left-6 top-6">
                  <SimpleIcon icon={siApple} className="size-8 fill-primary-foreground" />
                </div>
                <div className="absolute top-1/2 w-full -translate-y-1/2">
                  <div className="flex items-end justify-between px-6">
                    <span className="font-mono text-lg font-medium uppercase leading-none tracking-wide text-accent">
                      Arham Khan
                    </span>
                    <ChipSVG />
                  </div>
              ...
              <div className="space-y-4">
                <h6 className="text-sm uppercase text-muted-foreground">Recent Payments</h6>
                    ...
                    <div key={transaction.id} className="flex items-center gap-2">
                      ...
                      <div className="flex w-full items-end justify-between">
                        <div>
                          ...
                          <p className="line-clamp-1 text-xs text-muted-foreground">{transaction.subtitle}</p>
                        </div>
                        <div>
                          <span
                            className={cn(
